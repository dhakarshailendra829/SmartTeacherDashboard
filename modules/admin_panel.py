...
def admin_panel(data_path="data/teacher_dataset_100.csv"):
    ...
    if os.path.exists(appointment_file):
        appt_df = pd.read_csv(appointment_file, parse_dates=['Date'])
    ...
    if os.path.exists(thoughts_file):
        ...
        # --- Word Cloud of Feedback (optional) ---
        # You can generate word cloud if needed with WordCloud lib
    ...
    st.markdown("---")
    st.success("Admin Panel - Analytics loaded successfully!")
